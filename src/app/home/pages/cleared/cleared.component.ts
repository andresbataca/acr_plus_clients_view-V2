...
import { UbicationDataService } from '../../../core/services/ubication-data.service';
import { Observable, Subject, Subscription, catchError, of, share, takeUntil, tap, throwError } from 'rxjs';
